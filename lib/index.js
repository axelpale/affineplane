...
// Projection to a root plane.
exports.basis = require('./basis')

// Distance measure.
exports.dist2 = require('./dist2')

// Margin for non-strict numeric equality.
exports.epsilon = require('./epsilon')

// Two-dimensional linear similarity transformation.
exports.linear2 = require('./linear2')

// Two-dimensional point. Two points cannot be added but
// a distance and mean can be computed between them.
