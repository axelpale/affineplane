...
module.exports = (tr, plane, camera) => {
  // affineplane.helm3.projectToPlane(tr, plane, camera)
  //
  ...
  if (camera) {
    ...
    if (distToTr === 0) {
      ...
      // Treat tr as helm2 projected onto the reference plane.
      tr = scaleBy(tr, camera, ratio)
    }
  }

  // Project orthogonally onto the target plane in 2d space.
