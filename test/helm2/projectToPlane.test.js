...
module.exports = (ts) => {
  ts.test('case: basic orthogonal projection to plane', (t) => {
    ...
    t.deepEqual(
      helm2.projectToPlane({ a: 2, b: 0, x: 3, y: 0 }, plane),
      { a: 2, b: 0, x: 3, y: 0 },
      'trivial'
    )
    ...
    t.deepEqual(
      helm2.projectToPlane({ a: 2, b: 0, x: 3, y: 0 }, planeb),
      { a: 1, b: 0, x: 1, y: -1 },
  ...
  ts.test('case: basic perspective projection to plane', (t) => {
    ...
    t.deepEqual(
      helm2.projectToPlane({ a: 2, b: 0, x: 3, y: 0 }, plane, camera),
      { a: 0, b: 0, x: 1, y: 1 },
    ...
    t.deepEqual(
      helm2.projectToPlane({ a: 2, b: 0, x: 2, y: 0 }, planeb, camerab),
      { a: 1, b: 0, x: 1, y: 0 },
    ...
    t.deepEqual(
      helm2.projectToPlane({ a: 6, b: 0, x: 6, y: 0 }, planec, camerac),
      { a: 1, b: 0, x: 1, y: 0 },
