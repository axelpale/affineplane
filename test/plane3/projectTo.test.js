...
module.exports = (ts) => {
  ts.test('case: basic orthogonal projection to plane', (t) => {
    ...
    t.deepEqual(
      plane3.projectTo({ a: 2, b: 0, x: 3, y: 0, z: 2 }, target),
      { a: 2, b: 0, x: 3, y: 0 },
    ...
    t.deepEqual(
      plane3.projectTo({ a: 2, b: 0, x: 3, y: 0, z: 2 }, targetb),
      { a: 1, b: 0, x: 1, y: -1 },
  ...
  ts.test('case: basic perspective projection to plane', (t) => {
    ...
    t.deepEqual(
      plane3.projectTo({ a: 2, b: 0, x: 3, y: 0, z: 0 }, target, camera),
      { a: 0, b: 0, x: 1, y: 1 },
    ...
    t.deepEqual(
      plane3.projectTo({ a: 2, b: 0, x: 2, y: 0, z: 0 }, targetb, camerab),
      { a: 1, b: 0, x: 1, y: 0 },
    ...
    t.deepEqual(
      plane3.projectTo({ a: 2, b: 0, x: 2, y: 0, z: -2 }, targetc, camerac),
      { a: 1, b: 0, x: 1, y: 0 },
