...
module.exports = (ts) => {
  ...
  ts.test('case: 45 deg to ortho', (t) => {
    ...
    const ROT40 = tran2.fromPolar(1, DEG40)
    const ROT50 = tran2.fromPolar(1, DEG50)
    const ROTNEG40 = tran2.inverse(ROT40)
  ...
  ts.test('case: 135 deg to ortho', (t) => {
    ...
    const ROT130 = tran2.fromPolar(1, DEG130)
    const ROT135 = tran2.fromPolar(1, DEG135)
    const ROT140 = tran2.fromPolar(1, DEG140)
    ...
    t.transformEqual(
      ...
      tran2.rotateBy(ROT130, c1, -DEG40),
